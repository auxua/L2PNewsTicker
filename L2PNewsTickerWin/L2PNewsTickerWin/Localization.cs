...
namespace L2PNewsTickerWin
{
    public class Localization
    {
        ...
        public static string Localize(string key)
        {
            ...
            //ResourceManager temp = default(ResourceManager);
            ...
            //temp = new ResourceManager("L2PNewsTickerWin." + ProjectInfix() + ".L2PNewsTickerResources", typeof(Localization).GetTypeInfo().Assembly);
            ...
            //ResourceCandidate res1 = ResourceManager.Current.MainResourceMap.GetValue("Resources/" + key);
